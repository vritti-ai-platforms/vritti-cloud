...
// Fetches a single role with permissions
export function useRole(versionId: string, id: string, options?: Omit<UseQueryOptions<RoleDetail, AxiosError>, 'queryKey' | 'queryFn'>) {
  return useQuery<RoleDetail, AxiosError>({
