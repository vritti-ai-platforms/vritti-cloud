...
import { requestPhoneIdentityVerification } from '@services/verification.service';

type UseRequestPhoneIdentityOptions = Omit<UseMutationOptions<IdentityVerificationResponse, AxiosError, void>, 'mutationFn'>;
