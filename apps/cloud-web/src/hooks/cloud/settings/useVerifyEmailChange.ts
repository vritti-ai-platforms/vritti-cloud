...
import { verifyEmailChange } from '@services/verification.service';
import { PROFILE_QUERY_KEY } from './useProfile';

type UseVerifyEmailChangeOptions = Omit<UseMutationOptions<SuccessResponse, AxiosError, { otpCode: string }>, 'mutationFn'>;
