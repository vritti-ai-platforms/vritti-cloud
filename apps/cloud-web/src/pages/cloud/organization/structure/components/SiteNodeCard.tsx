...
// Transacting site card — per-type rail + icon for identity, an operational spec strip for tax registration and timezone
export const SiteNodeCard = ({ data }: NodeProps<Node<SiteNodeData>>) => {
  ...
  return (
    <div className="group relative w-65 overflow-hidden rounded-lg border border-border bg-card shadow-sm transition-shadow hover:shadow-md">
