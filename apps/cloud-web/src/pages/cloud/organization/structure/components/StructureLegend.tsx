...
const Pip = ({ className }: { className: string }) => <span className={`h-3 w-[3px] rounded-sm ${className}`} />;

// Legend for the structure graph — mirrors the node tiers, edge kinds, and site-type color coding
