import { useFeaturesWithPermissions, useRolePermissions, useSetRolePermissions } from '@hooks/admin/roles';
...
import type { FeatureWithPermissions, PermissionEntry } from '@/schemas/admin/roles';
...
export const RolePermissionForm: React.FC<RolePermissionFormProps> = ({ roleId }) => {
  ...
  const { data: rolePermissions, isLoading: permissionsLoading } = useRolePermissions(versionId, roleId);
  ...
  const saveMutation = useSetRolePermissions();
