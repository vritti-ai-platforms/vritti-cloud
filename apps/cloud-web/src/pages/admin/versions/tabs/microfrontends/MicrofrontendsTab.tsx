...
import { AddMicrofrontendForm } from '../microfrontends/forms/AddMicrofrontendForm';
import { EditMicrofrontendForm } from '../microfrontends/forms/EditMicrofrontendForm';

const TABLE_SLUG = 'microfrontends';

export const MicrofrontendsTab = () => {
