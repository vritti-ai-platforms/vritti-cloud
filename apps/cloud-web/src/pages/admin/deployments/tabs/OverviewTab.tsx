...
import { DEPLOYMENT_STATUS_VARIANT, SECRET_AUTH_METHODS } from '@/schemas/admin/deployments';
...
export const OverviewTab: React.FC<OverviewTabProps> = ({ deployment }) => {
  const isAgent = deployment.managementMode === 'agent';
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4 border-t pt-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <DetailField
              ...
              type="string"
              value={
                <Badge variant={DEPLOYMENT_STATUS_VARIANT[deployment.status]}>{titleCase(deployment.status)}</Badge>
              }
            />
          ...
          <div className="space-y-4 border-t pt-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <DetailField
                ...
                type="string"
                value={
                  <Badge variant={deployment.mode === 'managed' ? 'secondary' : 'outline'}>
              ...
              <DetailField
                ...
                type="string"
                value={
                  <Badge variant={deployment.addonGitea ? 'success' : 'secondary'}>
                    {deployment.addonGitea ? 'Enabled' : 'Disabled'}
                  </Badge>
                }
              />
            </div>
        ...
        {isAgent && secretProvider && (
          <div className="space-y-4 border-t pt-6">
            <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Secret Store</p>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
