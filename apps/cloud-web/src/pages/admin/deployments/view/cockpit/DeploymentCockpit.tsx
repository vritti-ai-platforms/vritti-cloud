...
// The managed deployment's Overview tab: reconcile banner + host gauges + component grid. The event timeline
// lives in its own Activity tab (ActivityTab / useDeploymentActivity).
