...
export function getOrgPermissions(orgId: string): Promise<SiteMatrix> {
  return axios.get<SiteMatrix>(`cloud-api/organizations/${orgId}/apps/permissions`).then((r) => r.data);
}
