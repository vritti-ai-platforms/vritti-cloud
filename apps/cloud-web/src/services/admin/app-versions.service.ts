...
export function createAppVersion(data: CreateAppVersionData): Promise<CreateResponse<AppVersion>> {
  return axios.post<CreateResponse<AppVersion>>('admin-api/app-versions', data).then((r) => r.data);
}
