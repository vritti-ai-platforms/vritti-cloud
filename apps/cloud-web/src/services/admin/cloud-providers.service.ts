...
export function createCloudProvider(data: CloudProviderPayload): Promise<CreateResponse<CloudProvider>> {
  return axios.post<CreateResponse<CloudProvider>>('admin-api/cloud-providers', data).then((r) => r.data);
}
