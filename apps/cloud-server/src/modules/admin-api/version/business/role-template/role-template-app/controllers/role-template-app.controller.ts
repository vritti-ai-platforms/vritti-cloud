import { RoleTemplateAppService } from '@domain/version/business/role-template/role-template-app/services/role-template-app.service';
...
} from '../docs/role-template-app.docs';
...
@Controller('versions/:versionId/businesses/:businessId/role-templates/:roleTemplateId/apps')
