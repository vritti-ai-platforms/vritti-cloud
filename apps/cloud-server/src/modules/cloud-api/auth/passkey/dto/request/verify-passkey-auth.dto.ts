...
export class VerifyPasskeyAuthDto {
  ...
  @ApiProperty({
    ...
    example: {
      ...
      response: {
        clientDataJSON:
          'eyJ0eXBlIjoid2ViYXV0aG4uZ2V0IiwiY2hhbGxlbmdlIjoiZEdWemRDMWphR0ZzYkdWdVoyVXRZbUZ6WlRZMCIsIm9yaWdpbiI6Imh0dHBzOi8vZXhhbXBsZS5jb20ifQ',
...
export class StartPasskeyAuthDto {
  @ApiPropertyOptional({
    description:
      'User email address to identify which passkey credentials to allow. If not provided, all registered passkeys for discoverable credentials will be allowed',
