...
import { RoleTemplateAppTableRowDto } from '@/modules/admin-api/version/business/role-template/role-template-app/dto/entity/role-template-app-table-row.dto';
import type { RoleTemplateAppTableResponseDto } from '@/modules/admin-api/version/business/role-template/role-template-app/dto/response/role-template-app-table-response.dto';
