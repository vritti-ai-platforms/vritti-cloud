...
import { PriceDetailDto, type PriceWithRelations } from '@/modules/admin-api/price/dto/entity/price-detail.dto';
import type { CreatePriceDto } from '@/modules/admin-api/price/dto/request/create-price.dto';
import type { UpdatePriceDto } from '@/modules/admin-api/price/dto/request/update-price.dto';
import { PricesTableResponseDto } from '@/modules/admin-api/price/dto/response/prices-table-response.dto';
