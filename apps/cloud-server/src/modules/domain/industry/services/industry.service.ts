...
import { IndustryDto } from '@/modules/admin-api/industry/root/dto/entity/industry.dto';
import type { CreateIndustryDto } from '@/modules/admin-api/industry/root/dto/request/create-industry.dto';
import type { UpdateIndustryDto } from '@/modules/admin-api/industry/root/dto/request/update-industry.dto';
import { IndustryTableResponseDto } from '@/modules/admin-api/industry/root/dto/response/industries-response.dto';
import { CloudIndustryDto } from '@/modules/cloud-api/industry/dto/entity/industry.dto';
...
export class IndustryService {
  ...
  // Returns all industries mapped to CloudIndustryDto
  async findAllForCloud(): Promise<CloudIndustryDto[]> {
    const industries = await this.industryRepository.findAll();
    this.logger.log(`Fetched all industries (${industries.length})`);
    return industries.map((industry) => CloudIndustryDto.from(industry));
  }
