...
import type { AssignIndustryAppDto } from '@/modules/admin-api/industry/industry-app/dto/request/assign-industry-app.dto';
import type { UpdateIndustryAppDto } from '@/modules/admin-api/industry/industry-app/dto/request/update-industry-app.dto';
